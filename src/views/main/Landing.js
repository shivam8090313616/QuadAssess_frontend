    ...
    <>
      ...
      >
            ...
            <Row className="align-items-center">
              <Col lg="6" className="text-left fade-in">
                ...
                <p className="lead text-white mt-3 mb-5">
                  Unlock your potential with real-time AI-driven feedback, mock interviews, and growth tracking. Enhance your skills and advance your career.
                </p>
                <Button
                  color="primary"
                  size="lg"
              ...
              <Col md="6" className="fade-in">
                <Card className="feature-card">
                  ...
                  <CardBody>
                    ...
                    <CardText>
                      Enhance your interview skills with AI-driven mock sessions designed to simulate real-life scenarios.
                    </CardText>
                  </CardBody>
                </Card>
              </Col>
              <Col md="6" className="fade-in">
                <Card className="feature-card">
                  ...
                  <CardBody>
                    ...
                    <CardText>
                      Receive immediate, actionable insights from AI to fine-tune your performance and ace the interview.
                    </CardText>
                  </CardBody>
                </Card>
              </Col>
              <Col md="6" className="fade-in">
                <Card className="feature-card">
                  ...
                  <CardBody>
                    ...
                    <CardText>
                      Visualize your progress over time with detailed analytics and performance tracking to see your improvement.
                    </CardText>
                  </CardBody>
                </Card>
              </Col>
              <Col md="6" className="fade-in">
                <Card className="feature-card">
                  ...
                  <CardBody>
                    ...
                    <CardText>
                      Tailor the mock interview experience to your preferences with adjustable difficulty levels and feedback modes.
                    </CardText>
                  </CardBody>
                </Card>
              </Col>
        ...
        <section className="testimonials-section hero-section text-white">
          <Container>
            <h2 className="text-center text-white">What Our Users Are Saying</h2>
        ...
        <section className="call-to-action text-center">
          <Container>
            ...
            <p>Join thousands of professionals advancing their careers with AI-powered mock interviews.</p>
            <Button
              color="success"
              size="lg"
              className="cta-button"
